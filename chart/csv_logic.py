...
def question1():
    primaryschool = '/Users/nak/Projects/Training/jango/tutorial/chart/assets/schools.csv'
    file = filehandler(primaryschool)
    data = file.readfile(district_name='district_name',category='cat',language='moi',school_name='name')
    return data

def question2():
    matches = '/Users/nak/Projects/Training/jango/tutorial/chart/assets/matches.csv'
